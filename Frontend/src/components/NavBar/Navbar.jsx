                    ...
                    <div>
                        <ul className=' space-x-8 lg:flex md:flex hidden '>
                            ...
                            <li className='relative group'>
                                ...
                                <ul className='absolute hidden group-hover:block bg-white shadow-lg p-2 space-y-2 w-52  z-50  '>
                                    <li><a href="#about-us" className="block px-4 py-2  hover:bg-green-300 hover:text-cyan-50 w-48">About Us</a></li>
                                    <li><a href="#board-of-directors" className="block px-4 py-2  hover:bg-green-300  hover:text-cyan-50 w-48">Board of Directors</a></li>
                                    <li><a href="#board-of-advisory" className="block px-4 py-2 hover:bg-green-300  hover:text-cyan-50 w-48">Board of Advisory</a></li>
                                </ul>
                            </li>
                            <li>What we do?</li>
                            <li className='relative group'>
